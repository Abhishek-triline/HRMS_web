...
/**
 * E-06 — Check In / Out (Employee)
 * Visual reference: prototype/employee/checkin.html
 *
 * Wraps <CheckInPanel /> (three-state cinematic hero).
 * Also shows:
 * - Today's record summary card
 * - LateMarkBanner (if lateMonthCount > 0)
 * - Attendance Rules collapsible section
 * - Link to Regularisation
 *
 * The #nx-tod-demo and #nx-state-demo prototype docks are NOT included (SRS § 10).
 */
