 ...
 *
 * All download buttons are stubbed (no backend endpoints exist yet).
 * Each fires a "Coming soon" info toast.
 * Recent Downloads renders the empty state — no audit feed in v1.0.
 */
