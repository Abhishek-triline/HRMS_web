...
/**
 * Manager Dashboard — Phase 0 stub.
 * Full implementation in Phase 2 (manager module).
 */
    ...
    <div>
      ...
      >
        <svg className="absolute inset-0 w-full h-full opacity-[0.10] pointer-events-none" aria-hidden="true">
          <defs>
            <pattern id="mgrDots" x="0" y="0" width="22" height="22" patternUnits="userSpaceOnUse">
              <circle cx="2" cy="2" r="1.4" fill="#FFFFFF" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#mgrDots)" />
        </svg>
        ...
        <div className="relative flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-sm text-mint/80 mt-0.5">Phase 0 scaffold — full dashboard coming in Phase 2</p>
          </div>
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        {['Team Members', 'On Leave Today', 'Pending Approvals', 'Review Deadlines'].map((tile) => (
