...
/**
 * A-17 — Tax Configuration (Admin).
 * Visual reference: prototype/admin/tax-config.html
 *
 * v1: single configurable reference rate (decimal, e.g. 0.095 = 9.5%).
 * The Indian slab engine is deferred to v2 (BL-036a).
 *
 * Shows: current rate, who last updated it, when, and an edit form.
 */
...
export default function TaxConfigPage() {
  ...
  // Displayed as percent (0.095 → "9.5")
  ...
  return (
    <div className="p-6">
      <div className="max-w-2xl mx-auto">
        {/* Page header */}
        <div className="mb-6">
          <h1 className="font-heading text-xl font-bold text-charcoal">Tax Settings</h1>
          <p className="text-xs text-slate mt-0.5">v1 manual reference rate — Indian slab engine deferred to v2 (BL-036a)</p>
        </div>
